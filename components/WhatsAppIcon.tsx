/**
 * The WhatsApp glyph, as a single path.
 *
 * Inline SVG rather than an image file: it inherits `currentColor`, so the same
 * mark works in gold on ink and ink on gold without a second asset, and it costs
 * no extra request on the mobile connections most ad traffic arrives on.
 */
